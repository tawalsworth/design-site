<template>
  <div class="relative bg-color-hero overflow-hidden">
    <div class="max-w-7xl mx-auto">
      <div class="relative justify-center z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32 ">
